"""
Django settings for tenant_vault project.
...
SECRET_KEY = 'django-insecure-9ewrn4=nhrwwa&r7+e=1jn!q3)&dk)p^=n)8&g!sa9ks6e(p#s'
...
WSGI_APPLICATION = 'tenant_vault.wsgi.application'
...
PUBLIC_SCHEMA_URLCONF = "tenant_vault.public_urls"